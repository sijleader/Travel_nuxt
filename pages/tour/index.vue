              ...
              <div class="row row-col-mob-gap">
                <div class="col-sm-3 col-xs-6">
                  <div class="feature feature-center">
                    ...
                    <div class="feature-caption _c-w">
                      <h5 class="feature-title _mb-10">هدایا و جوایز</h5>
                      <p class="feature-subtitle _op-06">
                        حتی بیشتر از خدمات ما دریافت کنید. کمتر خرج کنید و بیشتر
                        سفر کنید
                      </p>
                    </div>
                  </div>
                ...
                <div class="col-sm-3 col-xs-6">
                  <div class="feature feature-center">
                    ...
                    ></i>
                    <div class="feature-caption _c-w">
                      <h5 class="feature-title _mb-10">بهترین قیمت ها</h5>
                      <p class="feature-subtitle _op-06">
                        ما در حال مقایسه صدها وب سایت مسافرتی هستیم تا بهترین
                        قیمت را برای شما پیدا کنیم
                      </p>
                    </div>
                  </div>
                </div>
                <div class="col-sm-3 col-xs-6">
                  <div class="feature feature-center">
                    ...
                    ></i>
                    <div class="feature-caption _c-w">
                      <h5 class="feature-title _mb-10">3.5 متر مسافر</h5>
                      <p class="feature-subtitle _op-06">
                        از خدمات ما در سراسر جهان لذت بردیم
                      </p>
                    </div>
                  </div>
                </div>
                <div class="col-sm-3 col-xs-6">
                  <div class="feature feature-center">
                    ...
                    ></i>
                    <div class="feature-caption _c-w">
                      <h5 class="feature-title _mb-10">مدیر سفر</h5>
                      <p class="feature-subtitle _op-06">
                        با استفاده از مدیر رایگان و برنده جایزه ما، بر سفرهای
    ...
    >
      <div class="container">
        <div class="theme-page-section-header _ta-l">
          <h5 class="theme-page-section-title">تور های ترکیه</h5>
          <p class="theme-page-section-subtitle">
            محبوب ترین مقصد هموطنان عزیز
          </p>
        </div>
        <div class="row row-col-gap" data-gutter="10">
          <div class="col-sm-3 col-xs-6">
            ...
            >
              <div class="banner-bg b1"></div>
              <nuxt-link class="banner-link" to="/tour/post"></nuxt-link>
              <div
                class="banner-caption _pt-60 banner-caption-bottom banner-caption-grad"
              >
                <h5 class="banner-title _tt-uc _fs-sm _fw-b">کارگاه ها</h5>
          ...
          <div class="col-sm-3 col-xs-6">
            <div
              class="banner _br-4 banner-sqr banner-animate banner-animate-zoom-in banner-animate-very-slow banner-animate-mask-out"
            >
              <div class="banner-bg b2"></div>
              <nuxt-link class="banner-link" to="/tour/post"></nuxt-link>
              <div
                class="banner-caption _pt-60 banner-caption-bottom banner-caption-grad"
              >
                <h5 class="banner-title _tt-uc _fs-sm _fw-b">کنسرت ها</h5>
                <p class="banner-subtitle _fw-n">
                  شیوه قرار دادن لورم ایپسوم در پاراگراف
                </p>
              </div>
          ...
          <div class="col-sm-3 col-xs-6">
            <div
              class="banner _br-4 banner-sqr banner-animate banner-animate-zoom-in banner-animate-very-slow banner-animate-mask-out"
            >
              <div class="banner-bg b3"></div>
              <nuxt-link class="banner-link" to="/tour/post"></nuxt-link>
              <div
                class="banner-caption _pt-60 banner-caption-bottom banner-caption-grad"
              >
                <h5 class="banner-title _tt-uc _fs-sm _fw-b">هنرها</h5>
                <p class="banner-subtitle _fw-n">
                  شیوه قرار دادن لورم ایپسوم در پاراگراف
                </p>
              </div>
          ...
          <div class="col-sm-3 col-xs-6">
            <div
              class="banner _br-4 banner-sqr banner-animate banner-animate-zoom-in banner-animate-very-slow banner-animate-mask-out"
            >
              <div class="banner-bg b4"></div>
              <nuxt-link class="banner-link" to="/tour/post"></nuxt-link>
              <div
                class="banner-caption _pt-60 banner-caption-bottom banner-caption-grad"
              >
                <h5 class="banner-title _tt-uc _fs-sm _fw-b">غذا نوشیدنی</h5>
                <p class="banner-subtitle _fw-n">
                  شیوه قرار دادن لورم ایپسوم در پاراگراف
                </p>
              </div>
          ...
          <div class="row">
            <div class="col-md-8 col-md-offset-2 theme-page-header-abs">
              <div class="theme-page-header theme-page-header-lg">
                <h1 class="theme-page-header-title">در نیویورک گم شوید</h1>
                <p class="theme-page-header-subtitle">ارسال شده 5 روز پیش</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row row-col-mob-gap" data-gutter="60">
          <div class="col-sm-3 col-xs-6">
            <div class="feature feature-white feature-center">
              ...
              <div class="feature-caption">
                <h5 class="feature-title">جهان را سفر کنید</h5>
                <p class="feature-subtitle">سیر زندگی را نویسنده گفته است</p>
              </div>
            </div>
          </div>
          <div class="col-sm-3 col-xs-6">
            <div class="feature feature-white feature-center">
              ...
              ></i>
              <div class="feature-caption">
                <h5 class="feature-title">هدایا و جوایز</h5>
                <p class="feature-subtitle">
                  این متحدان است، تا الان طولی نمی کشد
                </p>
              </div>
            </div>
          </div>
          <div class="col-sm-3 col-xs-6">
            <div class="feature feature-white feature-center">
              ...
              ></i>
              <div class="feature-caption">
                <h5 class="feature-title">بهترین قیمت ها</h5>
                <p class="feature-subtitle">
                  مورب از همکاران لیبرو اتحادیه اروپا
                </p>
              </div>
            </div>
          </div>
          <div class="col-sm-3 col-xs-6">
            <div class="feature feature-white feature-center">
              ...
              ></i>
              <div class="feature-caption">
                <h5 class="feature-title">پشتیبانی 27/7</h5>
                <p class="feature-subtitle">
                  شیوه قرار دادن لورم ایپسوم در پاراگراف
                </p>
              </div>
...
.bg-pattern {
  background-image: url('~/static/img/patterns/ep_naturalblack.png');
}
...
.b1 {
  background-image: url('~/static/img/i7a_qufadzg_800x600.jpg');
}

.b2 {
  background-image: url('~/static/img/bve-xl2eqku_800x600.jpg');
}

.b3 {
  background-image: url('~/static/img/mxbylrhq4fk_800x600.jpg');
}

.b4 {
  background-image: url('~/static/img/food-on-table-326278_800x600.jpg');
}
</style>
